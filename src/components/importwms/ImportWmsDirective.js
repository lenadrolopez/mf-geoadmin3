...
(function() {
  ...
  module.controller('GaImportWmsDirectiveController',
      function($scope, $http, $q, $translate, gaUrlUtils, gaWms) {
          ...
          var getChildLayers = function(layer, wmsVersion) {
            ...
            if (layer.Layer) {
              ...
              for (var i = 0; i < layer.Layer.length; i++) {
                var l = getChildLayers(layer.Layer[i], wmsVersion);
                if (!l) {
  ...
  module.directive('gaImportWmsItem', function($compile) {
    ...
    var zoomToLayerExtent = function(layer, map) {
      ...
      var maxScaleDenominator = layer.MaxScaleDenominator;
      ...
      if (maxScaleDenominator && layerExtentScale > maxScaleDenominator) {
